...
class RecyclerView1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listgame.add(
            ItemData(R.drawable.danganropa," Game: Danganronpa: Trigger Happy Havoc",
        ...
        listgame.add(
            ItemData(R.drawable.bully,"Game: Bully", "Developer: Rockstar New england",
        ...
        listgame.add(
            ItemData(R.drawable.persona4,"Game: Persona 4", "Developer: Atlus",
        ...
        listgame.add(
            ItemData(R.drawable.residentevil7,"Game: Resident evil 7", "Developer: Capcom",
        ...
        listgame.add(
            ItemData(R.drawable.stardew,"Game: Stardew Valley", "Developer: ConcernedApe",
        ...
        listgame.add(
            ItemData(R.drawable.tothemoon,"Game: To The Moon", "Developer: Freebird Games",
        ...
        listgame.add(
            ItemData(R.drawable.findingparadise,"Game: Finding Paradise", "Developer: Freebird Games",
